...
public class HeroiEntity {
	...
	public HeroiEntity(Integer id, String nome, Integer level, Integer vida, Integer ataque, Integer defesa,
			String historia, Integer pocao, Integer magia, String imagem, String logo, String imgbatalha,
			Integer pontos, String status) {
		this.id = id;
		this.nome = nome;
		this.level = level;
		this.vida = vida;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		HeroiEntity other = (HeroiEntity) obj;
